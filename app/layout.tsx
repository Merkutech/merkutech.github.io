          ...
          <footer className="max-w-7xl mx-auto rounded-xl bg-white/[0.03] backdrop-blur-md border border-white/[0.06] px-5 py-4">
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-2">
                <SocialIcon href="https://tr.ee/y7R3ZogFWE" label="Merkutech Instagram">
                ...
                <SocialIcon href="https://tr.ee/hkEQATDD1j" label="Merkutech YouTube">
                  <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17"/>
                    <path d="m10 15 5-3-5-3z"/>
                  </svg>
                </SocialIcon>
                <SocialIcon href="https://tr.ee/jih1Q1HuiL" label="Merkutech LinkedIn">
                  <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5 text-[11px] text-neutral-500">
              <a href="https://tr.ee/seYDA9Xp9f" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Takım Başvurusu</a>
              <span className="text-neutral-800">·</span>
              <a href="https://tr.ee/l9ixE0FNU7" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Arel Savunma Sanayi WhatsApp</a>
              <span className="text-neutral-800">·</span>
              <a href="https://tr.ee/ZllLnHGwAJ" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Arel Savunma Sanayi Instagram</a>
              <span className="text-neutral-800">·</span>
